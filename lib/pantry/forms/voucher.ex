defmodule Pantry.Forms.Voucher do
  ...
  def changeset(voucher, attrs) do
    voucher
    |> cast(attrs, [:received_money, :received_food, :voucher_amount, :next_service_date, :client_id])
    |> validate_required([:received_money, :received_food, :voucher_amount, :next_service_date, :client_id])
  end
end
